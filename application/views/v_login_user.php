...
<head>
  ...
  <title> Admin | Tokoh Padamu</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?=base_url()?>assest/index2.html"><b>Tokoh</b>Padamu</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      ?>
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button name="cek"type="submit" class="btn btn-primary btn-block">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
        <?php form_close() ?>
